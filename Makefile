...
# AWS ECR Settings
DOCKER_REGISTRY ?= 700679597286.dkr.ecr.us-west-2.amazonaws.com
AWS_ACCOUNT_ID ?= 700679597286
DOCKER_LOGIN_EXPRESSION ?= eval $(aws ecr get-login --no-include-email --registry-ids $(AWS_ACCOUNT_ID) | sed 's/https\?:\/\///')
